  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p>Responsável pela operação diária: credenciamento de motoristas, processo de despacho de carga, gerenciamento de danos, meio campo entre motorista e financeiro.</p>
        </div>
        <!-- /.card-body -->
